...
const Untitled9 = () => {
  return <SafeAreaView style={styles.safeArea}>
      ...
      position: 'relative',
      flex: 1
    }}><View style={styles.GUxnrsIt}><View style={styles.SUyGDbjq}></View><View style={styles.DMCxoHaW}></View></View><ImageBackground style={styles.SbsrLikY} source={{
