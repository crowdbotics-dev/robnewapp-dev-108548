...
const PublishTest = () => {
  return <SafeAreaView style={styles.safeArea}>
      ...
      position: 'relative',
      flex: 1
    }}><Text style={styles.hNiRIEYL}>Lorem ipsum…</Text><ImageBackground style={styles.PqVzdGhX} source={{
      ...
      }} resizeMode="cover"></ImageBackground><Text style={styles.DcyQMbym}>Lorem ipsum…</Text></ScrollView>
    </SafeAreaView>;
};
